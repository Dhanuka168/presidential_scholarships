...
<body>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Caregiver (NVQ 3)</h1>
    ...
    <div class="container-xxl py-5">
        ...
        <div class="col-lg-12">
                    ...
                    <p class="mb-4 text-center">Caregiver (NVQ level 3) course conducted by Sri Jayawardhanapura General Hospital which aims the school levers after O/L to move forward making their carrier path as a caregiver.</p>
                    ...
                    <div class="row gy-1 gx-4 mb-4">
                        ...
                        <div class="col-sm-8">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i><strong>Duration</strong> 45 working days</p>
                        </div>
                        <div class="col-sm-8">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Practical sessions</p>
                        </div>
                    ...
                    <div class="row gy-1 gx-4 mb-4">
                        <div class="col-sm-8">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>get through the G.C.E.O/L Examination with Sinhala, Mathematics and English </p>
                        </div>
                    </div>
                </div>
            <div class="row">
