...
<body>
    ...
    <!-- Header Start -->
    <div class="container-fluid bg-primary py-5 mb-5 page-header" style="background-image: url('home/img/bar_service2.jpeg'); height: 500px;">
        <!-- <img class="img-fluid" src="home/img/house_keeping.jpeg" /> -->
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Craft Level Resturents and Bar Service (NVQ 4)</h1>
    ...
    <div class="container-xxl py-5">
        ...
        <div class="col-lg-12">
                    ...
                    <p class="mb-4 text-center">Craft Level Resturents and Bar Service is NVQ level 4 course conducted by Sri Lanka Institute of Tourism and Hotel Management.</p>
