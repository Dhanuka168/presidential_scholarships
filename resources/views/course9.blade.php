...
<body>
    ...
    <!-- Header Start -->
    <div class="container-fluid bg-primary py-5 mb-5 page-header" style="background-image: url('home/img/excavator.jpg'); height: 500px;">
        <!-- <img class="img-fluid" src="home/img/house_keeping.jpeg" /> -->
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Crawler Excavator Operator (NVQ 3)</h1>
    ...
    <div class="container-xxl py-5">
        ...
        <div class="col-lg-12">
                    ...
                    <p class="mb-4 text-center">Crawler Excavator Operator (NVQ 3) course conducted by State Development and Construction Corporation which aims the school levers after O/L to move forward making their carrier path as a Crawler Excavator Operator.</p>
                    ...
                    <div class="row gy-1 gx-4 mb-4">
                        ...
                        <div class="col-sm-8">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i><strong>Training Period</strong> 10 days</p>
                        </div>
